#!/usr/bin/env python3
"""
Test script to verify reenlistment flow works correctly
"""

import character_generation_rules as chargen
import random

def test_reenlistment_flow():
    """Test the complete reenlistment flow"""
    print("Testing Reenlistment Flow")
    print("=" * 50)
    ...
    print("\n4. Spending skill eligibilities...")
    ...
    # Ageing (should happen automatically after skills)
    print("\n5. Ageing process...")
    ...
    print(f"Ageing effects: {ageing_result.get('ageing_effects', [])}")
    ...
    if reenlistment_result.get('continue_career', False):
        print("\n7. Verifying readiness for next term...")
